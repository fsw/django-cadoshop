...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.extra_search_terms'
        db.add_column(u'cadoshop_productcategory', 'extra_search_terms',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


        # Changing field 'ProductCategory.name'
        db.alter_column(u'cadoshop_productcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):
        # Deleting field 'ProductCategory.extra_search_terms'
        db.delete_column(u'cadoshop_productcategory', 'extra_search_terms')


        # Changing field 'ProductCategory.name'
        db.alter_column(u'cadoshop_productcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'cadoshop.productcategory': {
            ...
            'extra_search_terms': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
