...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cadoshop_product', 'extra', self.gf('cadoshop.fields.ExtraFieldsValues')(null=True))

        # Changing field 'ProductCategory.extra_fields'
        db.alter_column('cadoshop_productcategory', 'extra_fields', self.gf('cadoshop.fields.ExtraFieldsDefinition')(null=True))
