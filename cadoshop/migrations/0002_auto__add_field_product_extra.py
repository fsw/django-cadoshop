...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.extra'
        db.add_column('cadoshop_product', 'extra',
                      self.gf('cadoshop.models.ExtraFieldsValues')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.extra'
        db.delete_column('cadoshop_product', 'extra')
    ...
    models = {
        'cadoshop.product': {
            ...
            'extra': ('cadoshop.models.ExtraFieldsValues', [], {}),
